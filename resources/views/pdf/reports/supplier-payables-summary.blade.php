...
<table class="main-table">
    <thead><tr><th>المورد</th><th class="ltr">الهاتف</th><th class="ltr">عملة</th><th class="ltr">أوامر شراء</th><th class="ltr">دفعات</th><th class="ltr">تسويات</th><th class="ltr">المتبقي</th></tr></thead>
    <tbody>
        @foreach($rows as $row)
        <tr>
