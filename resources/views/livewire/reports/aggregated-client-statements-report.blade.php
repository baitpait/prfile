<div>
    <div class="flex flex-wrap items-start justify-between gap-4 mb-6">
        <div>
            <h1 class="text-2xl font-bold text-[#3D3D3D]">كشوف العملاء المجمّعة</h1>
    ...
    <div class="flex flex-wrap gap-4 mb-4">
        ...
        <div class="card px-4 py-2 text-sm">
            ...
            <span class="font-mono font-bold text-[#C9A227] mr-2" dir="ltr">{{ number_format($t['balance'], 2) }}</span>
        </div>
        @endforeach
    </div>
    @endif
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="font-mono font-semibold text-left text-[#C9A227]" dir="ltr">{{ number_format($row['balance'], 2) }}</td>
