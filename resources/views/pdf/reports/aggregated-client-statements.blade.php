...
<div class="summary-box">
    ...
    <div class="summary-row"><span>{{ $cur }} ({{ $t['clients'] }} عميل)</span><span>{{ number_format($t['balance'], 2) }}</span></div>
    @endforeach
</div>
@endif
@if($rows->isEmpty())
...
<table class="main-table">
    <thead><tr><th>العميل</th><th class="ltr">عملة</th><th class="ltr">فواتير</th><th class="ltr">دفعات</th><th class="ltr">تسويات</th><th class="ltr">الرصيد</th><th class="ltr">حركات</th></tr></thead>
    <tbody>
        @foreach($rows as $row)
        <tr>
